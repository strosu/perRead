...
namespace PerRead.Backend.Migrations
{
    ...
    [Migration("20220413114826_AddRequireConfirmationAbove")]
    partial class AddRequireConfirmationAbove
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArticleAuthor", b =>
                {
                    b.Property<int>("UnlockedArticlesArticleId")
                        .HasColumnType("INTEGER");

                    b.Property<string>("UnlockedAuthorId")
                        .HasColumnType("TEXT");

                    b.HasKey("UnlockedArticlesArticleId", "UnlockedAuthorId");

                    b.HasIndex("UnlockedAuthorId");

                    b.ToTable("UnlockedArticles", (string)null);
                });
            ...
            modelBuilder.Entity("AuthorFeed", b =>
                {
                    b.Property<string>("SubscribedAuthorsAuthorId")
                        .HasColumnType("TEXT");

                    b.Property<string>("SubscribedFeedsFeedId")
                        .HasColumnType("TEXT");

                    b.HasKey("SubscribedAuthorsAuthorId", "SubscribedFeedsFeedId");

                    b.HasIndex("SubscribedFeedsFeedId");

                    b.ToTable("FeedAuthors", (string)null);
                });
            ...
            modelBuilder.Entity("ArticleAuthor", b =>
                {
                    b.HasOne("PerRead.Backend.Models.BackEnd.Article", null)
                        .WithMany()
                        .HasForeignKey("UnlockedArticlesArticleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PerRead.Backend.Models.BackEnd.Author", null)
                        .WithMany()
                        .HasForeignKey("UnlockedAuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AuthorFeed", b =>
                {
                    b.HasOne("PerRead.Backend.Models.BackEnd.Author", null)
                        .WithMany()
                        .HasForeignKey("SubscribedAuthorsAuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PerRead.Backend.Models.BackEnd.Feed", null)
                        .WithMany()
                        .HasForeignKey("SubscribedFeedsFeedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
